  ...
  return (
    ...
    <section
      ...
      <div className=' md:flex mt-10 mx-10 md:mx-44'>
        ...
        <div className='gradient rounded-t-full h-[24rem] sm:h-[28rem] md:h-[31.8rem] w-full md:w-[40%] overflow-hidden mx-auto pt-16 '><LazyLoadImage className='w-[80%] mx-auto ' effect="blur" src={me} alt="Image Alt" /></div>
        {/* <div className='flex flex-col text-sm  font-bold mr-10 '><h2 className='cursor-pointer mt-auto mb-40 rotatecls-90'>Scroll Down</h2></div> */}
      </div>
    </section>
